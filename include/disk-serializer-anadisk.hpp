...
#ifndef DISK_SERIALIZER_ANADISK_HPP_
#define DISK_SERIALIZER_ANADISK_HPP_

#include "disk-serializer.hpp"

class cDiskSerializerAnaDisk :
	public cDiskSerializer
{
public:

	cDiskSerializerAnaDisk( );
	virtual ~cDiskSerializerAnaDisk( ) override;
